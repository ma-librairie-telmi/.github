...
const config = {
    org: 'telmi-store',
    gistId: '49ed776755f3a01c995e78e3fd1cb79f',
    gistFilename: 'telmi-interactive.json',
    ...
    history: true,
    banner: {
        image: 'https://raw.githubusercontent.com/telmi-store/.github/master/profile/banner-telmi.jpg',
        background: '#2e144b',
